...
namespace Popa_Sebastian_Ioan_Lab2.Models

{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Popa_Sebastian_Ioan_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Popa_Sebastian_Ioan_Lab2Context context,
